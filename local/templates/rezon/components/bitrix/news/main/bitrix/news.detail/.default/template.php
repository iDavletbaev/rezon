...
//d($arResult['DISPLAY_PROPERTIES']);
//d($GLOBALS)
?>
<section class="main-special">
    <div class="main-special__box">
        <span class="main-special__box--text">
        ...
        <div class="main-special__header">
            <span class="main-special__header--text-color">Апартаменты</span>
        ...
        <div class="apartments__box--content">
            <div class="apartments__box--info">
                <div class="apartments__box--header">
                    <span class="apartments__box--text-color">Апартаменты</span>
                    ...
                    <div class="apartments__box--price">
                        ...
                        <span class="apartments__box--sale-price">
                            <?= $arResult['DISPLAY_PROPERTIES']['ACTUAL_PRICE']['VALUE'] ?>
            ...
            <div class="apartments__box--card-name">
                <div class="apartments__box--card-header">
                    ...
                    <div class="apartments__box--card-header-name">
                        <p class="apartments__box--card-header-name-title">Василий Петрович</p>
                ...
                <p class="apartments__box--card-name-text">У вас есть вопросы? Мы всегда рады помочь! Свяжитесь с нашим
                    агентом любым удобным для вас способом.</p>
        ...
        <div class="apartments__content">
            <div class="apartments__content--info">
                ...
                <table class="apartments__content--table">
                    ...
                    <?php
                    $obiInfo = array();
                    foreach ($arResult['DISPLAY_PROPERTIES']['OBJECT_INFO']['DISPLAY_VALUE'] as $key => $info) {
                        $obiInfo[$key]['NAME'] = $info;
                    }
                    foreach ($arResult['DISPLAY_PROPERTIES']['OBJECT_INFO']['DESCRIPTION'] as $key => $desc) {
        ...
        <div class="layout__body">
            <div class="layout__body--track">
                <div class="layout__body--slider">
                    ...
                    <?php foreach ($arResult['DISPLAY_PROPERTIES']['FLOOR_PLAN']['VALUE'] as $plan) {
            ...
            <div class="layout__body--info">
                ...
                <p class="layout__body--text">
                    <?=$arResult['DISPLAY_PROPERTIES']['PLAN_DESCRIPTION']['VALUE']['TEXT']?>
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="place__box">
        <div class="place__box--info">
            ...
            <div class="place__box--address"><span class="place__box--address-title">Адрес:</span>
                <span><?= $arResult['DISPLAY_PROPERTIES']['LOCALITY']['VALUE'] ?></span>
            </div>
        </div>
        <?php
        $location = explode(',', $arResult['DISPLAY_PROPERTIES']['LOCATION']['VALUE']);
        ?>
