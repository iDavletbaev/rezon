...
<section class="services" id="services">
    <div class="container services__container">
        <div class="services__item">
            ...
            <div class="services__item--content">
                ...
                <a class="services__item--button"><?=$arResult['DISPLAY_PROPERTIES']['BTN_TEXT']['VALUE']?></a>
            </div>
        </div>
        <div class="services__item">
  ...
  <div class="modal-form-services__content">
    ...
    <form action="" class="modal-form-services__form">
    ...
    <p>Нажимая кнопку «Отправить», я даю свое согласие на обработку моих персональных данных. <a href="">Подробнее</a></p>
    <input class="modal-form-services__form--btn" type="submit" value="Отправить">
    </form>
  </div>
</div>
</section>
